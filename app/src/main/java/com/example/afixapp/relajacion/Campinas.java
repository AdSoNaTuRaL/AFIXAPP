...
public class Campinas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_campinas);

        play_pause = findViewById(R.id.btn_campinas);
        mediaPlayer = MediaPlayer.create(this, R.raw.campinas);
    }
