...
public class Oceano extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oceano);

        play_pause = findViewById(R.id.btn_oceano);
        mediaPlayer = MediaPlayer.create(this, R.raw.oceano);
    }
